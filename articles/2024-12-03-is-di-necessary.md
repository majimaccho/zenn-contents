...
実際に、Ruby on Rails の作者である DHH は[Dependency injection is not a virtue](https://dhh.dk/2012/dependency-injection-is-not-a-virtue.html)という記事の中で、テストのためだけに DI をする必要はないと主張しています。
